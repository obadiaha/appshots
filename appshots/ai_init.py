...
def ai_generate_config(
    ...
    print(f"🔍 Analyzing {project.name} with AI...")
...
"""
    ...
    print(f"\n✅ AI-generated config written to {output_path}")
    
    # Check for NEEDS_USER_INPUT markers
    if "NEEDS_USER_INPUT" in config:
        print(f"\n⚠️  Some file paths need your input. Search for 'NEEDS_USER_INPUT' in {output_path}")
    ...
    if result.get("swift_code"):
        ...
        print(f"📝 Swift modifications saved to {swift_path}")
